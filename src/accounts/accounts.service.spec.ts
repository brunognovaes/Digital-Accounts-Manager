...
describe('AccountsService', () => {
  ...
  describe('cashIn', () => {
    ...
    it('should throw an error when account is inactive', () => {
      jest.spyOn(mockPrisma.account, 'findUnique').mockResolvedValue({...mockAccount, active: false});
    ...
    it('should throw an error when account is blocked', () => {
      jest.spyOn(mockPrisma.account, 'findUnique').mockResolvedValue({...mockAccount, blocked: true});
  ...
  describe('cashOut', () => {
    ...
    it('should throw and error when account has not enough balance', () => {
      jest.spyOn(mockPrisma.account, 'findUnique').mockResolvedValue({...mockAccount, balance: new Prisma.Decimal(0)});
