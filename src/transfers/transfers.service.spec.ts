...
describe('TransfersService', () => {
  ...
  describe('processStatus', () => {
    it('should update status successfully when transfer status is PENDING', () => {
      const response = transfersService.processStatus(mockId, TransferStatus.APPROVED)
    ...
    it('should throw an error when transfer status is APPROVED', () => {
      jest.spyOn(mockPrisma.transfer, 'findUnique').mockResolvedValue({...mockTransfer, status: TransferStatus.APPROVED});
    ...
    it('should throw an error when transfer status is REFUSED', () => {
      jest.spyOn(mockPrisma.transfer, 'findUnique').mockResolvedValue({...mockTransfer, status: TransferStatus.REFUSED});
